<template>
  <div class="detailsexpenses-content">
            ...
            <el-col :span="16" style="    text-align: left;padding-left: 10px;">
              ...
              <el-dropdown>
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item>上传医嘱</el-dropdown-item>
                  <el-dropdown-item>上传执行记录</el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
              <el-button type="primary" size="small">停用</el-button>
              <el-button type="primary" size="small">作废</el-button>
              <el-button type="primary" size="small">医嘱执行删除</el-button>
            </el-col>
          </el-col>
        </el-row>
      </el-form>
    </div>
    <div class="main-bottom-header"></div>
  </div>
</template>
