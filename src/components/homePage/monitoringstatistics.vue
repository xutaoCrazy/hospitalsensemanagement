      ...
      <el-col :span="24" style="padding-right:5px">
        <div class="search-time-bottom">
          <el-tabs v-model="activeName" @tab-click="tabsClick">
            <el-tab-pane label="监测项目合格率(类型)" name="first">
              <ICUpage-index></ICUpage-index>
            </el-tab-pane>
            <el-tab-pane label="监测项目合格率(科室)" name="second">
              <ICUpage-index></ICUpage-index>
            </el-tab-pane>
          </el-tabs>
        </div>
...
<script>
import ICUpageindex from "@/components/ICUpage/index"; //
export default {
  name: "",
  data() {
    return {
